...
var FindProxyForURL = function(init, profiles) {
    ...
    "+auto switch": function(url, host, scheme) {
        "use strict";
        if (/(?:^|\.)hatenablog\.jp$/.test(host)) return "+proxy";
        if (/(?:^|\.)zoudupai\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)macworld\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)etao\.com$/.test(host)) return "+proxy";
        ...
        if (/(?:^|\.)asciinema-bb-eu\.s3-eu-west-1\.amazonaws\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)laod\.cn$/.test(host)) return "+proxy";
        if (/(?:^|\.)github-production-user-asset-6210df\.s3\.amazonaws\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)ip\.cn$/.test(host)) return "+proxy";
        if (/(?:^|\.)arduino\.cc$/.test(host)) return "DIRECT";
        if (/(?:^|\.)localhost$/.test(host)) return "DIRECT";
        if (/(?:^|\.)google\.pl$/.test(host)) return "+proxy";
        ...
        if (/(?:^|\.)wallhaven\.cc$/.test(host)) return "+proxy";
        if (/(?:^|\.)pixelstalk\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)littleendiangamestudios\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)mpv\.io$/.test(host)) return "+proxy";
        if (/(?:^|\.)kknews\.cc$/.test(host)) return "+proxy";
        if (/(?:^|\.)aventertainments\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)nh87\.cn$/.test(host)) return "+proxy";
        if (/(?:^|\.)hxnews\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)idgesg\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)mybroadband\.co\.za$/.test(host)) return "+proxy";
        if (/(?:^|\.)bazaarvoice\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)quoracdn\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)readtiger\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)ttvnw\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)d2lv4zbk7v5f93\.cloudfront\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)twitch\.tv$/.test(host)) return "+proxy";
        if (/(?:^|\.)csdn\.net$/.test(host)) return "+proxy";
        if (/(?:^|\.)rackcdn\.com$/.test(host)) return "+proxy";
        ...
        if (/(?:^|\.)lbldy\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)tecmint\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)webupd8\.org$/.test(host)) return "+proxy";
        ...
        if (/(?:^|\.)qiaobutang\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)inboxsdk\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)bit\.ly$/.test(host)) return "+proxy";
        if (/(?:^|\.)beego\.me$/.test(host)) return "+proxy";
        if (/(?:^|\.)newegg\.cn$/.test(host)) return "+proxy";
        if (/(?:^|\.)codelast\.com$/.test(host)) return "+proxy";
        ...
        if (/(?:^|\.)searchpreview\.de$/.test(host)) return "+proxy";
        if (/(?:^|\.)qisuu\.com$/.test(host)) return "+proxy";
        if (/(?:^|\.)chromium\.org$/.test(host)) return "+proxy";
        if (/(?:^|\.)ywclub\.org$/.test(host)) return "+proxy";
        ...
        if (/(?:^|\.)openload\.io$/.test(host)) return "+proxy";
